...
Severity: #error
Expression: "extension.where(url = 'https://hl7chile.cl/fhir/ig/clembarazos/StructureDefinition/TipoDePartos').value.coding.exists(system = 'http://snomed.info/sct' and (code = '11636-8' or code = '11637-6' or code = '11638-4' or code = '11639-2' or code = '11640-0'))"
